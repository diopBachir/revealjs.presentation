...
**{{< fa angle-right >}}** Mise en place par Tramblay _et al._ [-@trambaly_et_al_2021_adhi], cette base de donne fournit une multitude d'indices hydrométriques et hydrologiques calculés à partir de différentes sources de données.<br>
...
| Afrique centrale    | 622                  | 42%         |
| Afrique du sud      | 205                  | 14%         |
...
Cette étude a été réalisée sur la région ouest-africaine. Les données de la base de données ADHI utilisées dans ce travail concernent donc les stations localisées en Afrique de l'ouest. <br>

**{{< fa angle-right >}}** La base comporte 441 stations réparties dans les différens pays de la région. <br>

**{{< fa angle-right >}}**  La superficie des bassins varie de 95 à 2150000 km^2^ et la plus longue série de débits journaliers est égale 44 années d'enregistrement. 
...
La sélection des bassins a été effectuée sur la base de trois critères :
...
:::
::: {.column width="50%"}
 ![Répartition de la superficie (Km^2^) des bassins retenus avec le
critère 2 (détection de valeurs aberrantes). La ligne tiretée rouge matérialise le seuil retenu (150 000 Km^2^)](assets/images/Superficie_Bassins_Diagramme_En_Barre.jpg)
:::
::::
